...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', default='mydata', choices=['mnist', 'usps', 'reutersidf10k', 'pendigits', 'mydata'])
    ...
    # Define IDEC model
    idec = IDEC(dims=[x.shape[-1], 500, 500, 2000, 18], n_clusters=args.n_clusters)
