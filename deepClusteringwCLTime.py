# -*- coding: utf-8 -*-
"""
Created on Sun Oct 14 14:38:23 2018
...
from rnnAttention import RNNTime
...
class DeepClusteringTime(nn.Module):
    def __init__(self, input1_dim, embed1_dim, input2_dim, embed2_dim, n_centroids, encode_layers=[500, 200], decode_layers=[ 200, 500], mapping_layers=[100,200, 100], output_size = 53):
    ...
    def loss_function(self, x1, recon_x1, x2, recon_x2, rnn_data, rnn_labels, q1, q2, emb1, emb2):
        ...
        pred_loss = ceLoss(pred, torch.max(rnn_labels, 1)[1])
    ...
    def fit(self, qdata, fdata, rnn_data, rnn_labels, lr = 0.001, num_epoch = 10):
        ...
        rnn_labels = Variable(torch.Tensor(rnn_labels)).long()
